...
export class RenderService {
   ...
   */
  public async renderManifest(manifest: Manifest, onProgress?: (progress: number) => void, customOutputPath?: string): Promise<string> {
    ...
    return await exporter(manifest, onProgress, customOutputPath);
  }
}
