...
export function renderTextNodeToContext({
  ...
  ctx.textAlign = (el.style as any).textAlign || "center";
  ...
  if ((el.style as any).strokeColor) {
    ctx.strokeStyle = (el.style as any).strokeColor;
    ctx.lineWidth = (el.style as any).strokeWidth || 4;
    ctx.lineJoin = "round";
