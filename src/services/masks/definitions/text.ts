import type { ParamDefinition } from "@/core/params";
import type {
	MaskDefinition,
	MaskParamUpdateArgs,
	TextMask,
	TextMaskParams,
} from "@/services/masks/types";
import { DEFAULTS } from "@/components/editor/panels/timeline/defaults";
import { MIN_FONT_SIZE, MAX_FONT_SIZE } from "@/services/text/constants";
import {
	drawMeasuredTextLayout,
	measureTextLayout,
	strokeMeasuredTextLayout,
} from "@/services/text/primitives";
import { getTextMeasurementContext } from "@/services/text/measure-element";
import { getTextVisualRect } from "@/services/text/layout";
import {
	getBoxMaskHandlePositions,
	getBoxMaskRectOverlay,
} from "@/services/masks/handle-positions";
import { computeFeatherUpdate } from "@/services/masks/param-update";
import {
	setMaskLocalCenter,
	toGlobalMaskSnapLines,
} from "@/services/masks/geometry";
import {
	snapPosition,
	snapRotation,
	snapScale,
	type ScaleEdgePreference,
} from "@/components/editor/panels/preview/utils/preview-snap";
	...
	buildDefault(): Omit<TextMask, "id"> {
		return {
			...
			params: {
				...
				fontWeight: DEFAULTS.text.element.fontWeight as any,
				fontStyle: DEFAULTS.text.element.fontStyle as any,
