...
import {
	...
	isEffectParamPath,
} from "@/core/animation/effect-param-channel";
import {
	isGraphicParamPath,
	parseGraphicParamPath,
} from "@/core/animation/graphic-param-channel";
import {
	coerceParamValue,
...
export { coerceParamValue as coerceAnimationValueForParam, getParamValueKind, getParamDefaultInterpolation };
import {
	getElementParam,
} from "@/core/params/registry";
import type { TimelineElement } from "@/components/editor/panels/timeline";
import { isVisualElement } from "@/components/editor/panels/timeline/element-utils";
import { effectsRegistry, registerDefaultEffects } from "@/services/effects";
import { getGraphicDefinition } from "@/services/graphics";
import type { NumericSpec } from "@/core/animation/types";
...
export function isAnimationPath(
	...
	return (
		...
		// Any string can be an element param path — checked at runtime
		true
	);
}
